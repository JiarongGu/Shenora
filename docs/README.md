...
| Publishing the iOS face of `Shenora.Maui` / changing the release pipeline for mobile | `docs/2026-08-02-ios-release-design.md` (**DRAFT for review** — the three-job shape, what was measured vs assumed, and the one unverified bit). Retire it once the change lands. |
