# ROADMAP archive — the P1–P7 era (2026-07-30 → 2026-07-31), which produced v0.1.0

> **History. Everything here is DONE and shipped.** Split out of `docs/ROADMAP.md` on 2026-08-02
> because that file had grown past 1,800 lines and the current cycle was buried under a closed one.
> The living roadmap keeps the CURRENT cycle; this keeps the one that is finished.
>
> Read it for the WHY behind a v0.1.0-era decision — the phase narratives record what was tried,
> what was measured, and what was rejected. The task-level record is `tasks.md` beside this file;
> the permanent decisions are `../DECISIONS.md`.
