...
/// </list>
/// </summary>
public sealed class FileDialogFacade : BaseFacade
{
    /// <summary>The module name this facade answers on.</summary>
    /// <remarks>
    /// Fixed rather than configurable, unlike <see cref="OperationsFacade"/>'s. That one takes its name
    ...
    /// <param name="logger">Diagnostics, via <see cref="BaseFacade"/>.</param>
    public FileDialogFacade(IFileDialogs dialogs, ILogger<FileDialogFacade>? logger = null)
        : base(logger)
    {
