...
/// </para>
/// </summary>
public sealed class MediaPlayerFacade : BaseFacade
{
    ...
    public MediaPlayerFacade(IMediaPlayer? player, MediaPlayerOptions options, ILogger<MediaPlayerFacade>? logger = null)
        : base(logger)
    {
