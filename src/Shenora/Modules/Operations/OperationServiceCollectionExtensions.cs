...
/// app/test directly) plus <see cref="OperationsModule"/>, mapped like any other module through the
/// existing <see cref="IpcServiceCollectionExtensions.AddIpcModule{TFacade}"/>.
/// </summary>
public static class OperationServiceCollectionExtensions
{
        ...
        this IServiceCollection services, OperationRegistryOptions? options = null)
    {
        ...
        // SECOND `OperationsModule`, and two facades claiming one module name is a duplicate the
        ...
        // GetServices<IIpcModule>()-inside-a-singleton-factory pattern that caused the silent
        ...
        services.TryAddEnumerable(ServiceDescriptor.Singleton<IIpcModule, OperationsModule>());
