...
///
/// <para>
/// This is the composition point that keeps `Shenora` free of any reporting dependency. An
...
/// Layering is preserved either way: `Shenora.Ipc` may depend on `Shenora`, never the reverse
/// (D19/D20).
/// </para>
///
/// <para>
