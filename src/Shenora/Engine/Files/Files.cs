...
/// </para>
///
/// <para><b>Why this exists separately from the update queue</b> (<see cref="IFileUpdateQueue"/>, in the
/// same package since D55 folded the IO tier in — the two answer different questions, which is the point
/// the old package boundary happened to express). The queue is for
