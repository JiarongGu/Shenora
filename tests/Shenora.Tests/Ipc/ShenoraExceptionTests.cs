...
public class ShenoraExceptionTests
{
    ...
    {
        var ex = new ShenoraException("IMPORT_FAILED");
    ...
    {
        var ex = new ShenoraException("IMPORT_FAILED", "name", "MyThing");
    ...
    public void Inner_exception_is_preserved()
    {
        ...
        var ex = new ShenoraException("IMPORT_FAILED", null, "import blew up", inner);
    ...
    {
        var ex = new ShenoraException("IMPORT_FAILED", "name", "MyThing", "import blew up");
    ...
    public void ToError_omits_message_when_it_is_just_the_code()
    {
        ...
        var error = new ShenoraException("IMPORT_FAILED").ToError();
    ...
    public void Derived_exceptions_are_still_operation_exceptions()
    {
        ...
        ShenoraException ex = new AppSpecificException();
        Assert.Equal("APP_SPECIFIC", ex.ToError().Code);
    }

    private sealed class AppSpecificException() : ShenoraException("APP_SPECIFIC");
}
