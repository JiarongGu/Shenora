...
public class FileSystemExtensionsTests
{
    ...
    /// changes nothing the app is exposed to. ⚠ Contrast <c>MediaAccessOptions.AllowedRoots</c> (reached
    /// through <c>MediaPlayerOptions.Access</c>), which the kit refuses to default because it IS a
    ...
    public void Journal_and_locks_are_defaulted_under_the_app_data_directory()
    {
        ...
        Assert.False(Directory.Exists(Path.Combine(root.Root, "journal")),
